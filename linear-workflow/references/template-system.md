...
- Template fill ≠ creation authorization — still confirm per [issue-discovery.md](issue-discovery.md)
- Composite requests → one primary template; track rest as related issues
