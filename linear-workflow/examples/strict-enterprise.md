...
| Step | Behavior |
|---|---|
| Create | Issue + detailed audit (compliance notes) |
...
With `release_reconciliation: enabled`, marking one issue done can close related issues in the same release with coordinated audit comments.
